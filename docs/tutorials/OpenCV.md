...
- [01 OpenCV HSV Tracking](./notebooks/OpenCV-01-HSVtracking.ipynb): Introduction to OpenCV, image loading, and basic operations including color space conversions and webcam access.
